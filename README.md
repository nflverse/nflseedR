...
nflseedR is currently undergoing a major revision of the code base. We
are focusing very strongly on *performance* through the use of
data.table and more efficient logics. We plan to release these changes
as version 2. The date of the release is not yet fixed. At the moment,
version 2 is to be considered a beta.

We welcome any user who is willing to test version 2 and look for bugs!
You can install the latest version of v2 at any time by executing the
following code.

``` r
if (!require("pak")) install.packages("pak")
pak::pak("nflverse/nflseedR@v2")
```

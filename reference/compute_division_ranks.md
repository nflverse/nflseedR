...
- teams:
  ...
  This parameter is optional. If it is `NULL` the function will compute
  it internally, otherwise it has to be a data frame of all teams
...
#> ℹ 14:45:46 | Calculating team data
#> ℹ 14:45:46 | Calculating head to head
#> ℹ 14:45:46 | Calculating division rank #1
#> ℹ 14:45:46 | Calculating division rank #2
#> ℹ 14:45:46 | Calculating division rank #3
#> ℹ 14:45:46 | Calculating division rank #4
#> # A tibble: 64 × 16
...
#> # ℹ 5 more variables: conf_pct <dbl>, sov <dbl>, sos <dbl>, div_rank <dbl>,
#> #   max_reg_week <int>

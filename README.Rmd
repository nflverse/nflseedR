...
To get a bug fix or to use a feature from the development version, you can install the development version of nflseedR from [GitHub](https://github.com/nflverse/nflseedR) with:

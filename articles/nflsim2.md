...
#> ℹ 14:05:08 | Start simulation of 4 seasons in 2 chunks with a chunk size of 2.
#> ℹ 14:05:10 | CHUNK #1: Start simulation of regular season weeks "1", "2", "3",
#> …, "17", and "18"
#> ℹ 14:05:10 | Initiate Standings & Tiebreaking Data
#> ℹ 14:05:10 | Compute Division Ranks
#> ℹ 14:05:10 | Compute Conference Ranks
#> ℹ 14:05:10 | CHUNK #1: Start simulation of post season weeks "WC", "DIV",
#> "CON", and "SB"
#> ℹ 14:05:10 | Compute Draft Order
#> ℹ 14:05:10 | CHUNK #2: Start simulation of regular season weeks "1", "2", "3",
#> …, "17", and "18"
#> ℹ 14:05:10 | Initiate Standings & Tiebreaking Data
#> ℹ 14:05:10 | Compute Division Ranks
#> ℹ 14:05:10 | Compute Conference Ranks
#> ℹ 14:05:10 | CHUNK #2: Start simulation of post season weeks "WC", "DIV",
#> "CON", and "SB"
#> ℹ 14:05:10 | Compute Draft Order
#> ℹ 14:05:10 | Combine simulation data
#> ℹ 14:05:10 | Aggregate across simulations
#> ℹ 14:05:10 | DONE!
```
...
#> ℹ 14:05:12 | Start simulation of 50 000 seasons in 20 chunks with a chunk size of 2 500.
#> ℹ 14:09:51 | DONE!
```
...
#> ℹ 14:09:53 | Start simulation of 500 seasons in 1 chunk with a chunk size of 500.
#> 
#> ℹ 14:10:00 | DONE!
#> 
...
#> ℹ 14:10:00 | Start simulation of 500 seasons in 1 chunk with a chunk size of 500.
#> ℹ 14:10:07 | DONE!
sims3$overall |> 
  dplyr::arrange(-wins) |> 
  gt::gt_preview(top_n = 5, bottom_n = 5)

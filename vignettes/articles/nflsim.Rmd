...
The highest rating shown here is simulation number 3. Let's examine the Bears' games
in that simulation:
...
the Elo above. Second, it makes sense that this would be a simulations where the Bears' Elo is
on the high side - but not super high - relative to the others shown. The Bears went 2-1 in
these games, with the loss being very close and the one of the wins being a blowout.

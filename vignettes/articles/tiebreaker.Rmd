...
*This is being used to calculate the variable `div_rank`*
...
*This is being used to calculate the variable `conf_rank`*
...
*This is being used to calculate the variable `draft_rank`*
